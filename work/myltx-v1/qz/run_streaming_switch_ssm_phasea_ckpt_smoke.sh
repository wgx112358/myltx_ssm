...
MANIFEST_PATH="${MANIFEST_PATH:-ode/switch_episodes_longlive_phaseA_256.jsonl}"
SSM_CHECKPOINT="${SSM_CHECKPOINT:-/inspire/hdd/project/agileapplication/zhangkaipeng-24043/wgx/myltx-v1/outputs/self_forcing_longlive_phaseA_decay025_v1/ssm_weights_step_00300.pt}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/streaming_switch_ssm_phaseA_ckpt_smoke_v1}"
